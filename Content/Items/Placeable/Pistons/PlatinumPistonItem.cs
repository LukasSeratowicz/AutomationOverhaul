...
{
    public class PlatinumPistonItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Pistons/PlatinumPistonItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<PlatinumPiston>();
            Item.placeStyle = 0;
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<SilverPistonItem>())
                .AddIngredient(ItemID.PlatinumBar, 5)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<TungstenPistonItem>())
                .AddIngredient(ItemID.PlatinumBar, 5)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
        }
