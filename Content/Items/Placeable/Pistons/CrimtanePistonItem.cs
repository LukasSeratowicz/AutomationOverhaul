...
{
    public class CrimtanePistonItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Pistons/CrimtanePistonItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<CrimtanePiston>();
            Item.placeStyle = 0;
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<PlatinumPistonItem>())
                .AddIngredient(ItemID.CrimtaneBar, 5)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<GoldPistonItem>())
                .AddIngredient(ItemID.CrimtaneBar, 5)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
        }
