...
{
    public class MeteoritePistonItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Pistons/MeteoritePistonItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<MeteoritePiston>();
            Item.placeStyle = 0;
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<CrimtanePistonItem>())
                .AddIngredient(ItemID.MeteoriteBar, 5)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<DemonitePistonItem>())
                .AddIngredient(ItemID.MeteoriteBar, 5)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
        }
