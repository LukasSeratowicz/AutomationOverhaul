...
{
    public class AdamantitePistonItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Pistons/AdamantitePistonItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<AdamantitePiston>();
            Item.placeStyle = 0;
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<MythrilPistonItem>())
                .AddIngredient(ItemID.AdamantiteBar, 5)
                .AddTile(TileID.MythrilAnvil)
                .Register();
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<OrichalcumPistonItem>())
                .AddIngredient(ItemID.AdamantiteBar, 5)
                .AddTile(TileID.MythrilAnvil)
                .Register();
        }
