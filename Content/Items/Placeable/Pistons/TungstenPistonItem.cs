...
{
    public class TungstenPistonItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Pistons/TungstenPistonItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<TungstenPiston>();
            Item.placeStyle = 0;
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<LeadPistonItem>())
                .AddIngredient(ItemID.TungstenBar, 5)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<IronPistonItem>())
                .AddIngredient(ItemID.TungstenBar, 5)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
        }
