...
{
    public class LuminitePistonItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Pistons/LuminitePistonItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<LuminitePiston>();
            Item.placeStyle = 0;
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<HallowedPistonItem>())
