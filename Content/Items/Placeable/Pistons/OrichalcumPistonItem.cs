...
{
    public class OrichalcumPistonItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Pistons/OrichalcumPistonItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<OrichalcumPiston>();
            Item.placeStyle = 0;
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<CobaltPistonItem>())
                .AddIngredient(ItemID.OrichalcumBar, 5)
                .AddTile(TileID.MythrilAnvil)
                .Register();
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<PalladiumPistonItem>())
                .AddIngredient(ItemID.OrichalcumBar, 5)
                .AddTile(TileID.MythrilAnvil)
                .Register();
        }
