...
{
    public class HallowedPusherItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Pushers/HallowedPusherItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<HallowedPusher>();
            Item.placeStyle = 0;
            //editable:
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<AdamantitePusherItem>())
                .AddIngredient(ItemID.HallowedBar, 6)
                .AddTile(TileID.MythrilAnvil)
                .Register();
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<TitaniumPusherItem>())
                .AddIngredient(ItemID.HallowedBar, 6)
                .AddTile(TileID.MythrilAnvil)
                .Register();
        }
