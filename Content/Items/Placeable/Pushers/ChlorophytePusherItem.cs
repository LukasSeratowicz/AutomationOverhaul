...
{
    public class ChlorophytePusherItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Pushers/ChlorophytePusherItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<ChlorophytePusher>();
            Item.placeStyle = 0;
            //editable:
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<HallowedPusherItem>())
