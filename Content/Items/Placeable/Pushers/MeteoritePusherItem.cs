...
{
    public class MeteoritePusherItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Pushers/MeteoritePusherItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<MeteoritePusher>();
            Item.placeStyle = 0;
            //editable:
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<CrimtanePusherItem>())
                .AddIngredient(ItemID.MeteoriteBar, 6)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<DemonitePusherItem>())
                .AddIngredient(ItemID.MeteoriteBar, 6)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
        }
