...
{
    public class AdamantitePusherItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Pushers/AdamantitePusherItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<AdamantitePusher>();
            Item.placeStyle = 0;
            //editable:
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<MythrilPusherItem>())
                .AddIngredient(ItemID.AdamantiteBar, 6)
                .AddTile(TileID.MythrilAnvil)
                .Register();
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<OrichalcumPusherItem>())
                .AddIngredient(ItemID.AdamantiteBar, 6)
                .AddTile(TileID.MythrilAnvil)
                .Register();
        }
