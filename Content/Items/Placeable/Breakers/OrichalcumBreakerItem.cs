...
{
    public class OrichalcumBreakerItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Breakers/OrichalcumBreakerItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<OrichalcumBreaker>();
            Item.placeStyle = 0;
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<CobaltBreakerItem>())
                .AddIngredient(ItemID.OrichalcumBar, 8)
                .AddTile(TileID.MythrilAnvil)
                .Register();
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<PalladiumBreakerItem>())
                .AddIngredient(ItemID.OrichalcumBar, 8)
                .AddTile(TileID.MythrilAnvil)
                .Register();
        }
