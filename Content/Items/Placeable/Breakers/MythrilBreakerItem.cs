...
{
    public class MythrilBreakerItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Breakers/MythrilBreakerItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<MythrilBreaker>();
            Item.placeStyle = 0;
