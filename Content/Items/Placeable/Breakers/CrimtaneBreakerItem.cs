...
{
    public class CrimtaneBreakerItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Breakers/CrimtaneBreakerItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<CrimtaneBreaker>();
            Item.placeStyle = 0;
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<GoldBreakerItem>())
                .AddIngredient(ItemID.CrimtaneBar, 8)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<PlatinumBreakerItem>())
                .AddIngredient(ItemID.CrimtaneBar, 8)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
        }
