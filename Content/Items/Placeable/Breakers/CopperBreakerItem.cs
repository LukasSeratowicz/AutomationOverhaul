...
{
    public class CopperBreakerItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Breakers/CopperBreakerItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<CopperBreaker>();
            Item.placeStyle = 0;
