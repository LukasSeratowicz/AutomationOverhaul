...
{
    public class HallowedPistonItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Pistons/HallowedPistonItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<HallowedPiston>();
            Item.placeStyle = 0;
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<TitaniumPistonItem>())
                .AddIngredient(ItemID.HallowedBar, 5)
                .AddTile(TileID.MythrilAnvil)
                .Register();
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<AdamantitePistonItem>())
                .AddIngredient(ItemID.HallowedBar, 5)
                .AddTile(TileID.MythrilAnvil)
                .Register();
        }
