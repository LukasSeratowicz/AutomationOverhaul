...
{
    public class PalladiumPlacerItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Placers/PalladiumPlacerItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<PalladiumPlacer>();
        ...
        public override void UpdateInventory(Player player) {
            ...
            // Logic copied 1:1 from PalladiumPistonItem
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<HellstonePlacerItem>())
