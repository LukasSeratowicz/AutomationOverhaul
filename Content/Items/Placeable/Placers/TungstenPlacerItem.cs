...
{
    public class TungstenPlacerItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Placers/TungstenPlacerItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<TungstenPlacer>();
        ...
        public override void UpdateInventory(Player player) {
            ...
            // Logic copied 1:1 from TungstenPistonItem
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<LeadPlacerItem>())
                .AddIngredient(ItemID.TungstenBar, 3)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<IronPlacerItem>())
                .AddIngredient(ItemID.TungstenBar, 3)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
        }
