...
{
    public class CrimtanePlacerItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Placers/CrimtanePlacerItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<CrimtanePlacer>();
        ...
        public override void UpdateInventory(Player player) {
            ...
            // Logic copied 1:1 from CrimtanePistonItem
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<GoldPlacerItem>())
                .AddIngredient(ItemID.CrimtaneBar, 3)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<PlatinumPlacerItem>())
                .AddIngredient(ItemID.CrimtaneBar, 3)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
        }
