...
{
    public class ChlorophytePlacerItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Placers/ChlorophytePlacerItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<ChlorophytePlacer>();
        ...
        public override void UpdateInventory(Player player) {
            ...
            // Logic copied 1:1 from ChlorophytePistonItem
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<HallowedPlacerItem>())
