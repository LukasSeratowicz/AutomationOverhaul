...
{
    public class PlatinumPlacerItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Placers/PlatinumPlacerItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<PlatinumPlacer>();
        ...
        public override void UpdateInventory(Player player) {
            ...
            // Logic copied 1:1 from PlatinumPistonItem
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<SilverPlacerItem>())
                .AddIngredient(ItemID.PlatinumBar, 3)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<TungstenPlacerItem>())
                .AddIngredient(ItemID.PlatinumBar, 3)
                .AddTile(TileID.HeavyWorkBench)
                .Register();
        }
