...
{
    public class HellstonePlacerItem : ModItem
    {
        public override string Texture => "AutomationOverhaul/Assets/Items/Placers/HellstonePlacerItem";
        ...
        public override void SetDefaults() {
            ...
            Item.createTile = ModContent.TileType<HellstonePlacer>();
        ...
        public override void UpdateInventory(Player player) {
            ...
            // Logic copied 1:1 from HellstonePistonItem
        ...
        public override void AddRecipes() {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<MeteoritePlacerItem>())
