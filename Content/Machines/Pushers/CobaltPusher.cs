...
{
    public class CobaltPusher : ModTile
    {
        public override string Texture => "AutomationOverhaul/Assets/Tiles/Pushers/CobaltPusher";
        ...
        public override void SetStaticDefaults() {
            ...
            RegisterItemDrop(ModContent.ItemType<CobaltPusherItem>());
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<CobaltPusherTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is CobaltPusherTE pusher) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                 ModContent.GetInstance<CobaltPusherTE>().Kill(i, j);
            }
        }
