...
{
    public class GoldPusher : ModTile
    {
        public override string Texture => "AutomationOverhaul/Assets/Tiles/Pushers/GoldPusher";
        ...
        public override void SetStaticDefaults() {
            ...
            RegisterItemDrop(ModContent.ItemType<GoldPusherItem>());
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<GoldPusherTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is GoldPusherTE pusher) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                 ModContent.GetInstance<GoldPusherTE>().Kill(i, j);
            }
        }
