...
{
    public class PlatinumPusher : ModTile
    {
        public override string Texture => "AutomationOverhaul/Assets/Tiles/Pushers/PlatinumPusher";
        ...
        public override void SetStaticDefaults() {
            ...
            RegisterItemDrop(ModContent.ItemType<PlatinumPusherItem>());
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<PlatinumPusherTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is PlatinumPusherTE pusher) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                 ModContent.GetInstance<PlatinumPusherTE>().Kill(i, j);
            }
        }
