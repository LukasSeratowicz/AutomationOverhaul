...
{
    public class TitaniumBreaker : ModTile
    {
        public override string Texture => "AutomationOverhaul/Assets/Tiles/Breakers/TitaniumBreaker";
        ...
        public override void SetStaticDefaults() {
            ...
            RegisterItemDrop(ModContent.ItemType<TitaniumBreakerItem>());
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<TitaniumBreakerTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is TitaniumBreakerTE machine) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                ...
                ModContent.GetInstance<TitaniumBreakerTE>().Kill(i, j);
            }
        }
    }
}