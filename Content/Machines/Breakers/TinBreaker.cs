...
{
    public class TinBreaker : ModTile
    {
        public override string Texture => "AutomationOverhaul/Assets/Tiles/Breakers/TinBreaker";
        ...
        public override void SetStaticDefaults() {
            ...
            RegisterItemDrop(ModContent.ItemType<TinBreakerItem>());
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<TinBreakerTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is TinBreakerTE machine) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                ...
                ModContent.GetInstance<TinBreakerTE>().Kill(i, j);
            }
        }
    }
}