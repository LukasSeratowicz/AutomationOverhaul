...
{
    public class PalladiumBreaker : ModTile
    {
        public override string Texture => "AutomationOverhaul/Assets/Tiles/Breakers/PalladiumBreaker";
        ...
        public override void SetStaticDefaults() {
            ...
            RegisterItemDrop(ModContent.ItemType<PalladiumBreakerItem>());
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<PalladiumBreakerTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is PalladiumBreakerTE machine) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                ...
                ModContent.GetInstance<PalladiumBreakerTE>().Kill(i, j);
            }
        }
    }
}