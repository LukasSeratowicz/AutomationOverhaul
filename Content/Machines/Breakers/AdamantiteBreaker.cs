...
{
    public class AdamantiteBreaker : ModTile
    {
        public override string Texture => "AutomationOverhaul/Assets/Tiles/Breakers/AdamantiteBreaker";
        ...
        public override void SetStaticDefaults() {
            ...
            RegisterItemDrop(ModContent.ItemType<AdamantiteBreakerItem>());
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<AdamantiteBreakerTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is AdamantiteBreakerTE machine) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                ...
                ModContent.GetInstance<AdamantiteBreakerTE>().Kill(i, j);
            }
        }
    }
}