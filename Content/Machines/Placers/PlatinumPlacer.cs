...
{
    public class PlatinumPlacer : ModTile
    {
        public override string Texture => "AutomationOverhaul/Assets/Tiles/Placers/PlatinumPlacer";
        ...
        public override void SetStaticDefaults() {
            ...
            RegisterItemDrop(ModContent.ItemType<PlatinumPlacerItem>());
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<PlatinumPlacerTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is PlatinumPlacerTE machine) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                ...
                ModContent.GetInstance<PlatinumPlacerTE>().Kill(i, j);
            }
        }
