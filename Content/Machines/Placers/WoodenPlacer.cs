...
namespace AutomationOverhaul.Content.Machines.Placers
{
    public class WoodenPlacer : ModTile
    {
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<WoodenPlacerTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is WoodenPlacerTE machine) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                ...
                ModContent.GetInstance<WoodenPlacerTE>().Kill(i, j);
            }
        }
