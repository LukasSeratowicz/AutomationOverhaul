...
{
    public class ChlorophytePlacer : ModTile
    {
        public override string Texture => "AutomationOverhaul/Assets/Tiles/Placers/ChlorophytePlacer";
        ...
        public override void SetStaticDefaults() {
            ...
            RegisterItemDrop(ModContent.ItemType<ChlorophytePlacerItem>());
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<ChlorophytePlacerTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is ChlorophytePlacerTE machine) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                ...
                ModContent.GetInstance<ChlorophytePlacerTE>().Kill(i, j);
            }
        }
