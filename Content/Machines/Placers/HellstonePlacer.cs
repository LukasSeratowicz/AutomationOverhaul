...
{
    public class HellstonePlacer : ModTile
    {
        public override string Texture => "AutomationOverhaul/Assets/Tiles/Placers/HellstonePlacer";
        ...
        public override void SetStaticDefaults() {
            ...
            RegisterItemDrop(ModContent.ItemType<HellstonePlacerItem>());
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<HellstonePlacerTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is HellstonePlacerTE machine) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                ...
                ModContent.GetInstance<HellstonePlacerTE>().Kill(i, j);
            }
        }
