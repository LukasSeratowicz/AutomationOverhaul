...
{
    public class TitaniumPlacer : ModTile
    {
        public override string Texture => "AutomationOverhaul/Assets/Tiles/Placers/TitaniumPlacer";
        ...
        public override void SetStaticDefaults() {
            ...
            RegisterItemDrop(ModContent.ItemType<TitaniumPlacerItem>());
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<TitaniumPlacerTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is TitaniumPlacerTE machine) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                ...
                ModContent.GetInstance<TitaniumPlacerTE>().Kill(i, j);
            }
        }
