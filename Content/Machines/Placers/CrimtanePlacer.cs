...
{
    public class CrimtanePlacer : ModTile
    {
        public override string Texture => "AutomationOverhaul/Assets/Tiles/Placers/CrimtanePlacer";
        ...
        public override void SetStaticDefaults() {
            ...
            RegisterItemDrop(ModContent.ItemType<CrimtanePlacerItem>());
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<CrimtanePlacerTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is CrimtanePlacerTE machine) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                ...
                ModContent.GetInstance<CrimtanePlacerTE>().Kill(i, j);
            }
        }
