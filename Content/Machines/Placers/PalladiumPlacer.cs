...
{
    public class PalladiumPlacer : ModTile
    {
        public override string Texture => "AutomationOverhaul/Assets/Tiles/Placers/PalladiumPlacer";
        ...
        public override void SetStaticDefaults() {
            ...
            RegisterItemDrop(ModContent.ItemType<PalladiumPlacerItem>());
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<PalladiumPlacerTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is PalladiumPlacerTE machine) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                ...
                ModContent.GetInstance<PalladiumPlacerTE>().Kill(i, j);
            }
        }
