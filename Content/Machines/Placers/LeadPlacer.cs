...
{
    public class LeadPlacer : ModTile
    {
        public override string Texture => "AutomationOverhaul/Assets/Tiles/Placers/LeadPlacer";
        ...
        public override void SetStaticDefaults() {
            ...
            RegisterItemDrop(ModContent.ItemType<LeadPlacerItem>());
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<LeadPlacerTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is LeadPlacerTE machine) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                ...
                ModContent.GetInstance<LeadPlacerTE>().Kill(i, j);
            }
        }
