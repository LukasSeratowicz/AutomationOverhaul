...
{
    public class MeteoritePlacer : ModTile
    {
        public override string Texture => "AutomationOverhaul/Assets/Tiles/Placers/MeteoritePlacer";
        ...
        public override void SetStaticDefaults() {
            ...
            RegisterItemDrop(ModContent.ItemType<MeteoritePlacerItem>());
        ...
        public override void PlaceInWorld(int i, int j, Item item) {
            ...
            int id = ModContent.GetInstance<MeteoritePlacerTE>().Place(i, j);
            if (id != -1 && TileEntity.ByID.TryGetValue(id, out TileEntity te) && te is MeteoritePlacerTE machine) {
        ...
        public override void KillTile(int i, int j, ref bool fail, ref bool effectOnly, ref bool noItem) {
            if (!fail) {
                ...
                ModContent.GetInstance<MeteoritePlacerTE>().Kill(i, j);
            }
        }
